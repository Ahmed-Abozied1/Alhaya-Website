...
const MyServices = () => {
  return (
    <div className="flex flex-col-reverse sm:flex-row items-center justify-center">
      ...
      <p className="text-right font-semibold text-3xl leading-relaxed px-4 py-2 sm:w-1/2 sm:block  sm:py-4">
        احترافية فى تنفيذ الخدمات ودقة فى المواعيد <br />
        <span className="text-xl">
          {" "}
          لدينا فريق متخصص فى ادارة المواعيد وتسهيل جدولة الزيارات عشان ما نتأخر
          عليك دقيقة كل اللى يهمنا انك تكون راضى عشان تكون عميل عندنا هلطول
        </span>
        <p className="font-bold text-center">تجارب واراء عملائنا</p>
        <Button />
      </p>
    </div>
  );
